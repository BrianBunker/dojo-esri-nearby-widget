define([
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, _SelectionLayersMixin], {
        ...
        postCreate: function() {
            ...
            this.initUI();
            this.geometryService = esriConfig.defaults.geometryService || new GeometryService('https://services.beta-dginsight.com/arcgis/rest/services/Utilities/Geometry/GeometryServer');
        },
